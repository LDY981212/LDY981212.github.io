      ...
      >
        ...
        >
          ...
          <div className="flex flex-col gap-[0.6rem] text-left min-w-0 break-words">
            <span className="block font-bold text-[1.2rem] md:text-[1.4rem] lg:text-[1.8rem] text-gray-600">
              이름
            </span>
            <span className="block font-medium text-[1.1rem] md:text-[1.2rem] lg:text-[1.6rem] text-gray-700">
              이도엽
            </span>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="flex flex-col gap-[0.6rem] text-left min-w-0 break-words">
            ...
            <a
              className="block font-medium text-[1.1rem] md:text-[1.2rem] lg:text-[1.6rem] text-blue-500 break-all"
