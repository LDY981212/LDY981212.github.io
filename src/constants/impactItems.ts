...
const impactItems: ImpactItem[] = [
  ...
  },
  {
    metric: "0.113 → 0",
    label: "이 페이지의 CLS",
    body: "히어로 강조어가 2.6초마다 회전하며 뒷 문장을 밀어내고 있었습니다. 지적을 받고 실제 Chrome에 PerformanceObserver를 붙여 측정하니 4분 체류 기준 CLS 0.113 · 시프트 92건이었습니다. 원인 두 가지를 제거해 0으로 만들고, 재확인할 수 있도록 측정 스크립트를 남겼습니다.",
    project: "개인 포트폴리오 웹",
    router: "individual",
  },
];
